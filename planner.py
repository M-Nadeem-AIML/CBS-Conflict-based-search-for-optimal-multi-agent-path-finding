...
class Planner:
    ...
    def plan(self, starts: List[Tuple[int, int]],
        ...
        print("solution started ==",solution)
    ...
    def calculate_goal_times(self, node: CTNode, agent: Agent, agents: List[Agent]):
        ...
        for other_agent in agents:
            ...
            # goal_times.setdefault(time, solution[other_agent][time], solution[agents][time])
        
        # goal_time.append(deepcopy(goal_times))
        with open('myfile.txt', 'a') as f:
            f.write(str(goal_times))
            f.write('\n')
